...
### 排他性分析（Exclusion Restriction） {.unnumbered}
...
### W1：基础设施投资（Infrastructure Investment） {.unnumbered}
...
### W2：政府干预（Government Intervention） {.unnumbered}
...
### W3：融资约束（Financing Constraints） {.unnumbered}
